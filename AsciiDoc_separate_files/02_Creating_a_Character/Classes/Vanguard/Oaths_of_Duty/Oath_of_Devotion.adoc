...
== Tenets of Devotion
Though the exact words and strictures of the {subclass-name-paladin-devotion} vary, {class-name-paladin}s of this oath share these tenets.
[horizontal]
...
.{subclass-name-paladin-devotion} Spells (table)
[%header,cols="1,3"]
|===
