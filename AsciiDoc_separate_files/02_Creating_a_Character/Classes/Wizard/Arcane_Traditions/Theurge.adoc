...
{class-name-wizard}s of this pursuit delve what other {class-name-wizard}s consider untouchable.
...
Whenever you gain a {class-name-wizard} level, you can replace one of the {class-name-wizard} spells you add to your spellbook with a spell from the <<spell-list-cleric,Cleric spell list>>.
Any Cleric spell you gain from this feature is considered a {class-name-wizard} spell for you and is recorded in your spellbook, but other {class-name-wizard}s are unable to copy these spells into their own spellbooks.
...
When you cast a 1st level or higher spell from the {class-name-wizard} spell list or a spell from the Cleric spell list as your action, you can cast a 1st level or higher spell from the other list with a casting time of an action or bonus action as a bonus action (regardless of its casting time).
The total level of the two spells combined cannot exceed your half your {class-name-wizard} level (rounded down).
