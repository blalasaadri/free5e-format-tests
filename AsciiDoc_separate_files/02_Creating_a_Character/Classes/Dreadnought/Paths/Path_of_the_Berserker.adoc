...
For some {class-name-barbarian}s, rage is a means to an end— that end being violence. The {subclass-name-barbarian-berserker} is a path of untrammeled fury, slick with blood. As you enter the berserker’s rage, you thrill in the chaos of battle, heedless of your own health or well-being.
